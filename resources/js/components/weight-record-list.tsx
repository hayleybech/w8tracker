                    ...
                    <table className="w-full text-left text-sm">
                        <thead className="border-b text-xs uppercase text-neutral-500 dark:text-neutral-400">
                            <tr>
                                ...
                                <th className="px-3 py-3 font-medium text-right">Weight (kg)</th>
                        ...
                        <tbody className="divide-y">
                            {records.map((record) => (
                                <tr key={record.id} className="hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
                                    ...
                                    <td className="px-3 py-3">{record.time.substring(0, 5)}</td>
                                    <td className="px-3 py-3 text-right font-mono">{record.weight_kg}</td>
